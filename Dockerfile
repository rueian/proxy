...
#
FROM quay.io/cilium/cilium-envoy-builder:eb2fa56cb545431cc6e8a4a4c2f0af2dd84d759c as builder
...
RUN make BAZEL_BUILD_OPTS=--jobs=3 PKG_BUILD=1 V=$V DESTDIR=/tmp/install cilium-envoy install
